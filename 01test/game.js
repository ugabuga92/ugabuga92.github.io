const Game = {
    ...
    init: function(saveData) {
        ...
        try {
            if (saveData) {
                this.state = saveData;
                // FIX: Sicherstellen, dass equip existiert, falls es im Savegame fehlt oder kaputt ist
                ...
                // Berechnung erst NACHDEM alles gesetzt ist
    ...
    // FIX: ROBUSTE STAT ABFRAGE (Verhindert Crash wenn Item fehlt)
    getStat: function(k) { 
        if(!this.state || !this.state.stats) return 5; // Fallback
