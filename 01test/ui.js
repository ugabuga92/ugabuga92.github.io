const UI = {
    // ... [Init, toggleView, etc. bleiben unverändert] ...
    els: {},
    timerInterval: null,
    ...
    init: function() {
        ...
        this.els = {
            ...
            version: document.getElementById('version-display'), // Referenz für Status
    ...
    // NEU: Status Anzeige Steuerung
    setConnectionState: function(status) {
        const v = this.els.version;
        if(!v) return;
        if(status === 'online') {
            v.textContent = "ONLINE (v0.0.8c)";
            v.className = "text-[#39ff14] font-bold tracking-widest"; // Grün
    ...
    // ... [toggleView, updateTimer, switchView, etc. bleiben gleich] ...
    ...
    renderChar: function() {
        ...
        // FIX: Level im Charakter-Screen updaten!
